...
from models.resnet34_model import ModifiedResNet34
...
model = ModifiedResNet34(num_outputs=1, dropout_rate=0.5).to(device)
...
for i, (images, _) in enumerate(test_loader):
    ...
    for j, image in enumerate(images):
        ...
        superimposed_img = apply_grad_cam(model, image, target_class, device)
